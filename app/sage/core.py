...
class SAGEPipeline:
    ...
    _QUERY_SYNONYMS: Dict[str, List[str]] = {
        ...
        "sell data":           ["confidentiality", "disclose data", "unauthorized disclosure",
                                "client data", "proprietary information", "data protection"],
        "selling data":        ["confidentiality", "disclose data", "unauthorized disclosure",
                                "client data", "proprietary information", "data protection"],
        "sell company data":   ["confidentiality", "disclose data", "unauthorized disclosure",
                                "client data", "proprietary information"],
        "selling company data": ["confidentiality", "disclose data", "unauthorized disclosure",
                                 "client data", "proprietary information"],
        "monetize data":       ["confidentiality", "data protection", "unauthorized disclosure",
                                "client data"],
        "share data":          ["confidentiality", "data disclosure", "third party", "client data",
                                "unauthorized disclosure"],
        "transfer data":       ["confidentiality", "data disclosure", "unauthorized access",
                                "client data", "data protection"],
        "leak data":           ["data breach", "unauthorized disclosure", "confidentiality",
                                "security incident"],
